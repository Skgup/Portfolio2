  ...
  return (
    <footer className="bg-gradient-to-r from-indigo-900 via-gray-800 to-gray-700 text-white text-center py-8">
      <div className="container mx-auto px-6">
        {/* Footer Text */}
        <p className="text-lg sm:text-xl font-semibold mb-4">&copy; 2024 Sumit Gupta. All rights reserved.</p>

        {/* Social Icons */}
        <div className="flex justify-center space-x-6 mt-4">
          <a
            href="https://github.com/Skgup"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/sumit-gupta-1b529b206/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-white hover:text-teal-600 transition-colors duration-300"
          >
