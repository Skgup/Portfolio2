  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-transparent backdrop-blur-lg shadow-lg z-50 transition-all duration-300 ease-in-out">
      <nav className="flex items-center justify-between p-5 max-w-6xl mx-auto">
        {/* Logo */}
        <h1 className="text-3xl font-display font-extrabold text-gray-200 hover:text-teal-500 transition-all duration-200">
          Sumit Gupta
        </h1>
        ...
        <div className="hidden font-family:League Spartan md:flex space-x-8">
          <Link
            ...
            smooth
            duration={500}
            className="text-lg text-gray-400 hover:text-teal-500 transition-all duration-200 uppercase"
          >
            Home
          </Link>
          <Link
      ...
      {isOpen && (
        ...
        >
          <Link
            ...
            className="text-xl text-gray-400 hover:text-teal-500 transition-all duration-200 uppercase"
          >
            Home
          </Link>
          <Link
