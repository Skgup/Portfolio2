...
const Hero = () => {
  return (
    <section id="hero" className="relative flex flex-col items-center justify-center h-screen bg-gradient-to-b from-gray-800 to-gray-900 text-white overflow-hidden">
      ...
      >
        A showcase of my work, skills, and passion for technology. Let's build something amazing together.
      </motion.p>
      ...
      <Link
        ...
        className="px-8 py-4 bg-gradient-to-r from-teal-400 to-teal-600 text-white font-semibold rounded-full shadow-xl transform transition-all hover:scale-105 hover:shadow-2xl focus:outline-none z-10"
      >
        View Projects
      </Link>
